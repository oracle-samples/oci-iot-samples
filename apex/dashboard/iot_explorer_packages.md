...
p_ocid varchar2 default null)`
    ...
    - Parameters:
      ...
      - `p_iot_domain_ocid` - domain ocid need when creating.
...
4. `IOT_OBJECTS.update_instance(p_ocid varchar2, p_body clob) return clob;`
    - Description: Calls the REST API to update a digital twin instance.
    - Parameters:
