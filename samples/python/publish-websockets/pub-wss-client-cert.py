...
Telemetry is sent using a persistent WebSockets connection.
...
client = mqtt.Client(mqtt.CallbackAPIVersion.VERSION2, transport="websockets")  # type: ignore
...
rc = client.connect(host=config.iot_device_host, port=WEBSOCKET_PORT, keepalive=60)
